...
function checkError() {
    ...
    if (neurons > 50 || neurons < 1 || learningRate > 1 || learningRate < 0.001 || hiddenLayers > 100 || hiddenLayers < 0 || epochs < 1 || epochs > 500 || min < -100 || min > 0 || max < 0 || max > 100 || numberValues < 1 || numberValues > 10000) {
