    ...
    getalldefs(args) {
      ...
      return Scratch.fetch(url)
        ...
        .then(text => {
          ...
          const definitions = Array.from(definitionElements).map(element => element.textContent);
          return definitions;
        })
        .catch(error => {
          return "Couldn't define";
